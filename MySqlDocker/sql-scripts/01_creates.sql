...
CREATE TABLE CLIENTE (
    ID_CLIENTE INT AUTO_INCREMENT PRIMARY KEY,       -- ID del cliente (clave primaria, autoincrementable)
...
CREATE TABLE TAXI (
    ...
    ID_CLIENTE INT,                                  -- ID del cliente asociado al taxi (relación con CLIENTE)
